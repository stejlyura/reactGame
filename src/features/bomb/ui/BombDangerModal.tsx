  ...
  return (
    <Modal open={open} onClose={onClose} ariaLabel="Danger ahead">
      <div className="flex flex-col items-center text-center">
        <img src="/logo.svg" className="h-6 mb-3 opacity-90" alt="brand" />
        ...
        <div className="relative my-6 h-36 w-36 rounded-full radial-burst-red grid place-items-center">
          <Icon src="/bomb.svg" alt="bomb" size={40} />
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 w-full">
          <GradientButton color="red" onClick={onTakeHit}>
            <span className="inline-flex items-center gap-2"><Icon src="/bomb.svg" alt="" size={18}/>Take a hit</span>
          </GradientButton>
          <GradientButton color="violet" onClick={onDefuse}>
            Defuse for <span className="ml-1 inline-flex items-center gap-1"><Icon src="/orb.svg" alt="" size={18}/>49</span>
          </GradientButton>
        </div>
      </div>
    </Modal>
